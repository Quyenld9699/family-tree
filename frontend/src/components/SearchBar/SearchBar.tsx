...
export default function SearchBar({ onSearch, onClose }: SearchBarProps) {
    ...
    const handleSearch = () => {
        ...
        // onClose called from parent after search
    };
    ...
    return (
        <>
            ...
            <div
                ref={wrapperRef}
                className="fixed top-[56px] sm:top-[52px] left-1/2 -translate-x-1/2 z-10 rounded-[16px] border px-3 py-3 md:px-4 flex flex-col md:flex-row items-stretch md:items-center gap-2 md:gap-3 w-[92vw] sm:w-[95%] md:w-auto justify-center"
            ...
            >
                ...
                <div className="flex items-center gap-2 w-full md:w-auto justify-between md:justify-start">
                    ...
                    {onClose && (
                        <button
                            onClick={onClose}
                            className="w-8 h-8 flex-shrink-0 flex items-center justify-center rounded-[10px] transition-colors"
                            style={{ backgroundColor: '#f9f7f2', color: '#6a6a6a' }}
                            title="Đóng"
                        >
