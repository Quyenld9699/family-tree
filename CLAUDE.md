# Family Tree Project — Hướng dẫn cho Claude

> Nội dung này được chuyển từ `.github/copilot-instructions.md` để Claude dùng làm context dự án.
> Nếu có chỉnh sửa kiến trúc/quy ước, cập nhật đồng thời cả hai file.
